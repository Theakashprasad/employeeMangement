...
export default function SignUpPage() {
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="w-[825px] flex-shrink-0 flex flex-col px-12 py-10 bg-white border border-[#E7E7E7] relative z-10 shadow-xl overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
          ...
          <p className="text-xs text-[#767F8C] leading-relaxed">
            ...
            <button
              type="button"
              className="text-[#18191C] underline hover:text-[#0A65CC] transition-colors"
            >
              Terms of use
            </button>{" "}
            and{" "}
