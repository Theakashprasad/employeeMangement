...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="w-[825px] flex-shrink-0 flex flex-col px-12 py-10 bg-white border border-[#E7E7E7] relative z-10 shadow-xl">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-[#18191C] mb-1.5">
            Log In to EmployeeHub
          </h1>
          <p className="text-sm text-[#767F8C]">
            Don&apos;t have an account?{" "}
            <Link
              to={ROUTES.signup}
              className="text-[#0A65CC] font-semibold hover:underline"
            >
              Sign Up
            </Link>
          </p>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex justify-end mt-1.5">
              <button
                type="button"
                className="text-xs text-[#767F8C] hover:text-[#0A65CC] transition-colors"
              >
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex-1 flex items-center justify-center gap-2 py-2.5 border border-[#E7E7E7] rounded-lg text-sm font-medium text-[#18191C] hover:bg-gray-50 transition-all"
          >
